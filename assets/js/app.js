document.addEventListener("DOMContentLoaded", () => {
  const applicationServerKey =
    "BC-AjyY60u9jS6CoeK2TQvIW0JbK7bT7m4PxrrzCWcqMmPsUtZ5QE4okGXuEqun5n_5OLPR8RNhj-yKFCVjlw4Y";
  ...
  function push_sendSubscriptionToServer(subscription, method) {
    ...
    // $.ajax({
    // 	type: "POST",
    // 	url: "https://localhost/apf/push_subscription",
    // 	data: {
    ...
    return fetch("https://localhost/apf/push_subscription", {
      method,
      body: JSON.stringify({
  ...
  //         method: "POST",
  //         body: JSON.stringify(
  //           Object.assign(jsonSubscription, { contentEncoding })
  //         ),
  //       });
  //     })
  // );
